...
Most of the `gopls` logic is in the `github.com/aligator/haiku-golang-tools/gopls/internal/lsp`
directory.
...
```bash
$ gopls version
github.com/aligator/haiku-golang-tools/gopls master
    github.com/aligator/haiku-golang-tools/gopls@(devel)
```
...
both the `golang.org/x/tools` and `github.com/aligator/haiku-golang-tools/gopls` modules, as
described above.

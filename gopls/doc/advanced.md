...
```sh
GO111MODULE=on go install github.com/aligator/haiku-golang-tools/gopls@vX.Y.Z
```
...
go get -d github.com/aligator/haiku-golang-tools/gopls@master golang.org/x/tools@master

go install github.com/aligator/haiku-golang-tools/gopls
```
...
```
$ go install github.com/aligator/haiku-golang-tools/gopls@latest
```
